...
# Set text
title_text = font.render("SNEKE", True, GREEN, DARKGREEN)
title_rect = title_text.get_rect()
title_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2)

score_text = font.render("Score: 0", True, GREEN, DARKGREEN)
...
continue_text = font.render("Continue", True, GREEN, DARKGREEN)
...
while running:
    ...
    # Check for game over
    if head_rect.left < 0 or head_rect.right > WINDOW_WIDTH or head_rect.top < 0 or head_rect.bottom > WINDOW_HEIGHT or head_coord in body_coord:
